...
const Rtip_Word32 E6 = 1000000;
const Rtip_Word32 E9 = 1000 * E6;
...
Rtip_Word32 EventPosix::Construct()
{
...
EventTypePosix EventPosix::Wait(Rtip_UWord32 timeout)
{
...
Rtip_Word32 EventPosix::Construct()
{
    ...
    Rtip_Word32 result = pthread_mutex_init(&m_mutex, 0);
    if (result != 0)
    {
        return -1;
    }
